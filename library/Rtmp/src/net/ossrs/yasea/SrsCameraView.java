...
public class SrsCameraView extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public boolean startCamera() {
        ...
        Log.i("camera","range0=="+range[0]+",range1==="+range[1]);
        params.setPreviewFpsRange(range[0], range[1]);
        Log.i("camera","mPreviewWidth=="+mPreviewWidth+",mPreviewHeight==="+mPreviewHeight);
        params.setPreviewSize(mPreviewWidth, mPreviewHeight);
        Log.i("camera","ImageFormat.NV21=="+ImageFormat.NV21);
        params.setPreviewFormat(ImageFormat.NV21);
        Log.i("camera","Camera.Parameters.FLASH_MODE_OFF=="+Camera.Parameters.FLASH_MODE_OFF);
        params.setFlashMode(Camera.Parameters.FLASH_MODE_OFF);
        Log.i("camera","Camera.Parameters.WHITE_BALANCE_AUTO=="+Camera.Parameters.WHITE_BALANCE_AUTO);
